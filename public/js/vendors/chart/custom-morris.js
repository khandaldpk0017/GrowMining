...
new Morris.Line({ 
  ...
  lineColors:[Codexomee.themeprimary,Codexomee.themesecondary],
  xkey: 'year',
  ykeys: ['value1','value2'], 
...
Morris.Bar({
  ...
  barColors:[Codexomee.themeprimary,Codexomee.themesecondary],
  xkey: 'y',
  ykeys: ['valuea', 'valueb'],
  labels: ['Series A', 'Series B']
});
...
Morris.Donut({
  ...
  colors:[Codexomee.themeprimary,Codexomee.themesecondary,Codexomee.themewarning,Codexomee.themeinfo]
});
