...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var COMPLEX_OPTION_COMPARATORS = {
        codexEvntFilter: isBoolComplexEqual,
    ...
    */
    ...
    StandardTheme.prototype.classes = {
        ...
        button: 'fc-button btn-icon-border',
    ...
    function parseToolbars(calendarOptions, calendarOptionOverrides, theme, viewSpecs, calendarApi) {
        var header = calendarOptions.codexEvntFilter ? parseToolbar(calendarOptions.codexEvntFilter, calendarOptions, calendarOptionOverrides, theme, viewSpecs, calendarApi) : null;
    ...
    var listPlugin = createPlugin({
        ...
        views: {
            ...
            listDay: {
                type: 'list',
                duration: { days: 1 },
                listDayFormat: { weekday: 'long' }, // day-of-week is all we need. full date is probably in codexEvntFilter
            },
            listWeek: {
                type: 'list',
                duration: { weeks: 1 },
