...
<body >
	...
	<!-- Title page -->
	<section class="bg-img1 m-t-80 txt-center p-lr-15 p-tb-92" :style="backgroundStyle">
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none" :src="contactBg" alt="ICON">
						</div>
	...
	<!-- Map -->
	<!-- <div class="map">
		<div class="size-303" id="google_map" data-map-x="40.691446" data-map-y="-73.886787" :data-pin="pin" data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
	</div> -->
...
import contactBgU from '../../../../public/images/icons/icon-email.png';
import pinU from '../../../../public/images/icons/pin.png';
...
export default {
  ...
  data() {
    return {
		backgroundImageUrl: 'images/bg-01.jpg' ,
     picon1:picon1U,
     picon2:picon2U,
     picon3:picon3U,
     picon4:picon4U,
     picon5:picon5U,
	 contactBg:contactBgU,
	 pin:pinU
    };
  },
};
